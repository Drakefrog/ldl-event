(function(global) {
  ...
  function SlideShow(aContainer, aSlides) {
    ...
    function onMouseDown(ev) {
      console.log(ev);
      ev.preventDefault();
      if (scope.blockUserInteraction) return;
    ...
    function showArrowButton() {
      ...
      var div = arrowButton,
          ...
          arrowW = scope.arrowW,
          arrowTop = (h*0.88 + h*currentSlide) + 'px';
    ...
    scope.enableUserInteraction = enableUserInteraction;
    scope.disableUserInteraction = disableUserInteraction;
    scope.showArrowButton = showArrowButton;
    scope.hideArrowButton = hideArrowButton;
    return scope;
  }
