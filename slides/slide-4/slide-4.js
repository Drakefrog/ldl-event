(function(app) {
  var d3 = app.d3,
      ...
      w = 15,
      arcData = [
        { startAngle: 60, endAngle: 270, color: '#1d3689', width: w },
        { startAngle: 60, endAngle: 270, color: '#1d3689', width: w },
        { startAngle: 60, endAngle: 270, color: '#1d3689', width: w },
        { startAngle: 60, endAngle: 270, color: '#0177c1', width: w },
        { startAngle: 60, endAngle: 270, color: '#0177c1', width: w },
        { startAngle: 60, endAngle: 270, color: '#0177c1', width: w },
        { startAngle: 60, endAngle: 270, color: '#73d36c', width: w },
        { startAngle: 60, endAngle: 270, color: '#73d36c', width: w },
        { startAngle: 60, endAngle: 270, color: '#73d36c', width: w },
        { startAngle: 60, endAngle: 270, color: '#30b949', width: w },
        { startAngle: 60, endAngle: 270, color: '#30b949', width: w },
        { startAngle: 60, endAngle: 270, color: '#30b949', width: 2*w }
      ],
      bgArc = d3.svg.arc()
